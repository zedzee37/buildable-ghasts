...
//			if (!(hitResult instanceof EntityHitResult entityHitResult) || entityHitResult.getEntity().getType() != EntityType.HAPPY_GHAST) {
//				return true;
//			}
...
//			HappyGhastEntity happyGhast = (HappyGhastEntity) entityHitResult.getEntity();
//
